...
const TouchData = [
  {
    img: location,
    data: "NC Towers , Chandigarh University , Mohalli",
  },
  {
    img: phone,
    data: "+91 8791615052",
            ...
            >
              <div className="flex flex-row gap-[20px]">
                <div className="flex flex-col gap-[10px]">
                  ...
                  <input
                    ...
                    className="border-[1px] outline-none font-walsheimReg text-darkblue w-[300px] p-3 h-[35px] border-[#ddd]"
              ...
              <div className="flex flex-col gap-[10px]">
                ...
                <textarea
                  name="message"
                  id="message"
                  className="border-[1px] outline-none font-walsheimReg text-darkblue   p-3 
                  border-[#ddd]"
