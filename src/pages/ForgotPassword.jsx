            ...
            <form onSubmit={handleOnSubmit}>
              {!emailSent && (
                <label className="w-full">
                  <p className="mb-1 text-[0.875rem] leading-[1.375rem] font-walsheimCon text-richblack-5">
              ...
              <button
                type="submit"
                className="mt-6 w-full rounded-[8px] duration-300 hover:scale-95 bg-yellow-50 py-[12px] px-[12px] font-medium text-richblack-900"
              >
