...
const Error = () => {
  return (
    <div className="w-full bg-[#fdfbf4] h-full flex flex-col">
      <Navbar />
      <div className="bg-[#FEFBF4] ">
        <div className="flex lg:flex-row gap-10 py-[120px] w-11/12 mx-auto  flex-col">
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <Link to="/">
              <button className="text-white bg-[#FE794F] cursor-pointer font-bold w-[266px] h-[60px] flex justify-center items-center font-walsheimMed duration-300 hover:scale-95">
                Go Back to Homepage
              </button>
            </Link>
          </div>
